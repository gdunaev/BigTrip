...
const getOfferComponent = (offers) => {
  ...
  if  (offers.length === 0) {
    ...
    return '';
        ...
        <input class="event__offer-checkbox  visually-hidden" id="event-offer-luggage-${index}" type="checkbox" name="event-offer-luggage" ${currentPoint.included === true ? 'checked' : ''}>
