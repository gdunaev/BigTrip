export const createContentItemTemplate = (point) => {
  ...
  const {isFavorite, offers, typePoint, dateFromOnlyDate, dateFromMonthDay, name,
    dateFromHourMinute, dateFromHour, dateToHourMinute, dateToHour,
    pointDuration, basePrice} = point;
